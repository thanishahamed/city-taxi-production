...
const ManagePassenger = () => {
    const result = useSWR({method: GET, url: API_ROUTE + '/auth/user/passenger'}, fetcher);
        ...
        if (isValidated) {
            ...
            if (requestObject.password !== requestObject.confirmPassword) {
                ...
                if (currentData.id) {
                    ...
                    requestObject.role = userRoles.passenger;
    ...
    return (
        <div className="pop-right">
            ...
            <div className="text-4xl pb-8 text-slate-800 font-semibold pop-up">Manage Passengers</div>
