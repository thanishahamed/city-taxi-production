...
const ManageDrivers = () => {
    const result = useSWR({method: GET, url: API_ROUTE + '/auth/user/driver'}, fetcher);
    ...
    return (
        <div className="pop-right">
            <div className="text-4xl pb-8 text-slate-800 font-semibold pop-up">Manage Drivers</div>
            <div className="flex justify-end m-5"><Button style="ghost"><i className="icon-plus-square-o text-xl text-yellow-500 pr-2"></i>Add New Record</Button></div>
